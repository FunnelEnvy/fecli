...
function LocalController(variation, port) {
  ...
  if(!this.project.loadFromFile()) {
    throw new Error("no project.json found; You really should run this from within the project directory.");
  }
  ...
  this.locals = {
    _port: this.port,
    edit_url: this.experiment.getFecliURL(),
...
LocalController.prototype.experimentCSS = function(req, res) {
