...
module.exports = function(varPath, port, program) {
  ...
  // Detect https edit URL (so '-s' option is not required)
  if (isHTTPS(localController.experiment.attributes.edit_url)) {
  ...
  app.get("/experiment.css", localController.experimentCSS.bind(localController));
